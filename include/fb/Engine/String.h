...
#define FB_STRING_EMPTYCHARS CYPRESS_GW_SELECT(0x141C710E0, 0x14294ED54, 0x143FFDDF8)
#define FB_STRING_SET CYPRESS_GW_SELECT(0x14036FFC0, 0x1401CE220, 0x14041E0C0)
...
namespace fb
{
    ...
    public:
        ...
        void freeRep()
        {
            if ((uintptr_t)m_chars != FB_STRING_EMPTYCHARS)
            {
                MemoryArena::free(m_chars);
            }
        }
    };
}